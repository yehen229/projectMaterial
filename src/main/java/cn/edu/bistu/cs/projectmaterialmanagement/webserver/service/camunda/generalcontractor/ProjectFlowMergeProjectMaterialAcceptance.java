 ...
 */
@Service
public class ProjectFlowMergeProjectMaterialAcceptance implements JavaDelegate {
    private final static Logger logger = LoggerFactory.getLogger(ProjectFlowMergeProjectMaterialAcceptance.class);
    ...
    public ProjectFlowMergeProjectMaterialAcceptance(IProjectOpHistoryBusiness projectHistoryBusiness,
