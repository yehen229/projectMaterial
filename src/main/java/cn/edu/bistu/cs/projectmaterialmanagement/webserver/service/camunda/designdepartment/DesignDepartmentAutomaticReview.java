...
@Service
public class DesignDepartmentAutomaticReview implements JavaDelegate {
    ...
    public DesignDepartmentAutomaticReview(IProjectOpHistoryBusiness projectHistoryBusiness,
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        //增加审核历史过程
        projectHistoryBusiness.addNotAffectAppearanceReviewDesignDepartmentAutomaticReview(businessId, user.getId(),
                                                                                           "设计部自动审核不影响外观",
                                                                                           "设计部自动审核不影响外观");
    }
}