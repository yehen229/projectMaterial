...
@Service
public class MakeSureTheMaterialCorrect implements JavaDelegate {
    private final static Logger logger = LoggerFactory.getLogger(MakeSureTheMaterialCorrect.class);
    private final IProjectOpHistoryBusiness projectHistoryBusiness;
    private final IUserService userService;

    public MakeSureTheMaterialCorrect(IProjectOpHistoryBusiness projectHistoryBusiness,
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        //增加审核历史过程
        projectHistoryBusiness.addQRCodeScan(businessId, user.getId(),
                                             "监理单位和施工单位共同确定材料正确",
