...
@Service
public class SetEngineeringDepartmentRemainingEmployeeListNotAffectAppearance implements ExecutionListener {
    private final static Logger logger = LoggerFactory.getLogger(
            SetEngineeringDepartmentRemainingEmployeeListNotAffectAppearance.class);

    private final IProjectUserService projectUserService;
    private final IProjectBusinessService projectBusinessService;

    public SetEngineeringDepartmentRemainingEmployeeListNotAffectAppearance(IProjectUserService projectUserService,
    ...
    public void notify(DelegateExecution delegateExecution) throws Exception {
        ...
        //设置项目经理还未汇总审核
        delegateExecution.setVariable("engineeringDepartmentManagerNotAffectAppearanceSummaryReview", 0);
