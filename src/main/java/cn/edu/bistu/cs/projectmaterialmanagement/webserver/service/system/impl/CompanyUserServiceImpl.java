...
public class CompanyUserServiceImpl implements ICompanyUserService {
    ...
    @Override
    public Page<CompanyUserView> getPageViewExcludingByCompanyId(String companyId,
                                                                 List<String> userIdList,
                                                                 Integer pageNo,
                                                                 Integer pageSize) {

        Page<CompanyUser> companyUserPage = getPageExcludingByCompanyId(companyId, userIdList, pageNo, pageSize);
        return convertCompanyUserPage2PageView(companyUserPage, pageNo, pageSize);

    }

    private Page<CompanyUser> getPageExcludingByCompanyId(String companyId,
                                                          List<String> userIdList,
                                                          Integer pageNo,
                                                          Integer pageSize) {

        return companyUserRepository.getPageExcludingByCompanyId(companyId, userIdList, pageNo, pageSize);
    }
