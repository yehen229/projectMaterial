...
//3453
    ...
    public String submitGeneralContractorSelectBrand(UseMaterialForm useMaterialForm) {
        ...
        if (task == null) {
            ...
            if ((nLen0 == 0 && nlen1 > 0) || (nLen0 > 0 && nlen1 == 0)) {
                //所有品牌是否影响外观的属性都相同，不需要拆分任务
                //项目员工审核项目
                ...
                runtimeService.createProcessInstanceModification(processInstance.getId())
                        ...
                        .setVariable("useMaterialBrandSelectId", useMaterialBrandSelectId1)
                        .execute();
                return "";
...
//                                    （从头最远走到订购）
    ...
    public ProjectStatisticalAnalysis getStatisticsOfProjectViewByTaskId(String taskId,
                                                                                   String projectId) {

        return projectBusinessService.getStatisticsOfProjectViewByProjectId(projectId);
    }
