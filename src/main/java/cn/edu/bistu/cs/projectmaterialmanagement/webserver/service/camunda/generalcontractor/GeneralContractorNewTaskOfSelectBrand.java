 ...
 */
@Service
public class GeneralContractorNewTaskOfSelectBrand implements JavaDelegate {
    ...
    public GeneralContractorNewTaskOfSelectBrand(IProjectOpHistoryBusiness projectHistoryBusiness,
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        logger.info("工作流-监听器:GeneralContractorNewTaskOfSelectBrand:" + delegateExecution.getEventName());
