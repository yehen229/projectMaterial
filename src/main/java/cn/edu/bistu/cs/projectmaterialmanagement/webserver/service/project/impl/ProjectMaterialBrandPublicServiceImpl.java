...
public class ProjectMaterialBrandPublicServiceImpl implements IProjectMaterialBrandPublicService {
    ...
    @Override
    public int getCountByProjectMaterialIdAndBrandPublicId(String projectMaterialId,
                                                            String brandPublicId) {
        return projectMaterialBrandPublicRepository.getCountByProjectMaterialIdAndBrandPublicId(projectMaterialId,brandPublicId);
    }
