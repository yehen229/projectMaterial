...
public class ProjectMaterialBrandPrivateServiceImpl implements IProjectMaterialBrandPrivateService {
     ...
     * @param brandName
     * @param brandPosition
     * @param brandMaterialClassifySectionId
     * @param projectMaterialId
     * @param projectId
     * @return
     */
    @Override
    public String add(String brandName,
                      String brandPosition,
                      String brandMaterialClassifySectionId,
                      String projectMaterialId,
                      String projectId) {
        Brand brand=new Brand();
        brand.setName(brandName);
        brand.setPosition(brandPosition);
        brand.setMaterialClassifySectionId(brandMaterialClassifySectionId);
        String brandId=brandService.add(brand);
        if(brandId==null)
            throw new RuntimeException("品牌添加失败");

        ProjectBrand projectBrand=new ProjectBrand();
        projectBrand.setBrandId(brandId);
        projectBrand.setProjectId(projectId);
        String projectBrandId=projectBrandService.add(projectBrand);
        if(projectBrandId==null)
            throw new RuntimeException("项目品牌添加失败");
        ...
        String projectMaterialBrandPrivateId=projectMaterialBrandPrivateRepository.add(projectMaterialBrandPrivate);
        if(projectMaterialBrandPrivateId==null)
            throw new RuntimeException("项目材料品牌私有添加失败");
    ...
    public String add(ProjectBrand projectBrand,
                      String projectMaterialId) {
        if(projectBrand==null || projectBrand.getId()==null)
            throw new RuntimeException("项目品牌添加失败:参数错误");

        ProjectMaterialBrandPrivate projectMaterialBrandPrivate=new ProjectMaterialBrandPrivate();
        projectMaterialBrandPrivate.setProjectBrandId(projectBrand.getId());
        projectMaterialBrandPrivate.setProjectMaterialId(projectMaterialId);
        String projectMaterialBrandPrivateId=projectMaterialBrandPrivateRepository.add(projectMaterialBrandPrivate);
        if(projectMaterialBrandPrivateId==null)
            throw new RuntimeException("项目材料品牌私有添加失败");
    ...
    @Override
    public String add(String brandId,
                      String projectMaterialId,
                      String projectId) {
    ...
    @Override
    public List<ProjectMaterialBrandPrivateView> getViewByProjectMaterialId(String projectMaterialId) {
        List<ProjectMaterialBrandPrivate> projectMaterialBrandPrivateList = projectMaterialBrandPrivateRepository.getByProjectMaterialId(projectMaterialId);
        return convertProjectMaterialBrandPrivateList2ListView(projectMaterialBrandPrivateList);
    }

    @Override
    public List<ProjectMaterialBrandPrivateView> getViewByProjectIdAndMaterialId(String projectId,
                                                                                 String materialId) {
        List<ProjectMaterialBrandPrivate> projectMaterialBrandPrivateList = projectMaterialBrandPrivateRepository.getByProjectIdAndMaterialId(projectId,
                                                                                                    materialId);
        return convertProjectMaterialBrandPrivateList2ListView(projectMaterialBrandPrivateList);
    }
