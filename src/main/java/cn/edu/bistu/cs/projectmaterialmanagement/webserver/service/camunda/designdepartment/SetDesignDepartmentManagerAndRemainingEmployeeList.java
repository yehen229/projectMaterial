...
@Service
public class SetDesignDepartmentManagerAndRemainingEmployeeList implements ExecutionListener {
    ...
    public SetDesignDepartmentManagerAndRemainingEmployeeList(IProjectUserService projectUserService) {
    ...
    public void notify(DelegateExecution delegateExecution) throws Exception {
        //得到设计部所有的员工
        List<ProjectUser> projectUserList = projectUserService.getManagerAndEmployeeOfDesignDepartment(delegateExecution.getBusinessKey());

        List<String> assigneeList = new ArrayList<String>(); //分配任务的人员

        //设置项目员工和项目经理（包括项目经理和项目员工均可以审批）
        ...
        //对应流程图Collection
        delegateExecution.setVariable("designDepartmentManagerAndEmployeeList", assigneeList);
