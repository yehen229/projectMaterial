...
public interface IUseMaterialNewBrandService {
    ...
    Page<UseMaterialNewBrandView> getPageView(int pageNo,
                                              int pageSize);

    Page<UseMaterialNewBrandView> getPageViewByUseMaterialId(String useMaterialId,
                                                             int pageNo,
                                                             int pageSize);

    Page<UseMaterialNewBrandView> getPageViewByMaterialClassifyDivisionId(String materialClassifyDivisionId,
                                                                          int pageNo,
                                                                          int pageSize);

    Page<UseMaterialNewBrandView> getPageViewByMaterialClassifyGroupId(String materialClassifyGroupId,
                                                                       int pageNo,
                                                                       int pageSize);

    Page<UseMaterialNewBrandView> getPageViewByMaterialClassifySectionId(String materialClassifySectionId,
                                                                         int pageNo,
                                                                         int pageSize);
