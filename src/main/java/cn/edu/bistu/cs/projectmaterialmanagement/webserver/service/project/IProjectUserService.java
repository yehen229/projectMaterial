...
public interface IProjectUserService {
    ...
    boolean getExistsDesignDepartmentManager(String projectId);

    boolean getExistsEngineeringDepartmentManager(String projectId);
    ...
    ProjectUserView getDesignDepartmentManager(String projectId);

    ProjectUserView getEngineeringDepartmentManager(String projectId);
    ...
    Page<CompanyUserView> getEngineeringDepartmentManagerCandidatesViewPageByProjectId(String projectId,
                                                                                       Integer pageNo,
                                                                                       Integer pageSize);

    Page<CompanyUserView> getDesignDepartmentManagerCandidatesViewPageByProjectId(String projectId,
                                                                                  Integer pageNo,
                                                                                  Integer pageSize);

    Page<CompanyUserView> getDesignDepartmentEmployeeCandidatesViewPageByProjectId(String projectId,
                                                                                   Integer pageNo,
                                                                                   Integer pageSize);

    Page<CompanyUserView> getEngineeringDepartmentEmployeeCandidatesViewPageByProjectId(String projectId,
                                                                                        Integer pageNo,
                                                                                        Integer pageSize);
