...
public interface IProjectMaterialBrandPrivateService {
    ...
    String add(String  brandName,String  brandPosition,String  brandMaterialClassifySectionId,String  projectMaterialId,String  projectId);
    String add(ProjectBrand projectBrand,String projectMaterialId);
    String add(String brandId, String projectMaterialId,String  projectId);
    ...
    List<ProjectMaterialBrandPrivateView> getViewByProjectMaterialId(String projectMaterialId);

    List<ProjectMaterialBrandPrivateView> getViewByProjectIdAndMaterialId(String projectId,
                                                                          String materialId);
}