...
//            return null;
    ...
    public String addFormOfGeneralContractorBrandSelectAndUseMaterial(UseMaterialForm useMaterialForm) {
        ...
        useMaterialForm.getUseMaterialFormItems().forEach(useMaterialFormItem -> {
            ...
            if ((projectMaterialBrandPublicId != null && !projectMaterialBrandPublicId.isEmpty()) ||
                    (projectMaterialBrandPrivateId != null && !projectMaterialBrandPrivateId.isEmpty())) {
            ...
            //新建品牌
            if (brandName != null && !brandName.isEmpty() && useMaterialId != null) {
        ...
        for (UseMaterial useMaterial : useMaterialList) {
            ...
            for (UseMaterialNewBrand useMaterialNewBrand : useMaterialNewBrandList) {
                ...
                if (brand == null) {
                    ...
                    brandId = brandService.add(brandTemp);


                } else brandId = brand.getId();
    ...
    public ProjectMaterialRetestView getFeedbackOfProjectMaterialAcceptanceReviewedByRetestId(String projectMaterialRetestId){
        ...
        if (projectUserService.isUserSupervisionCompanyEmployee(useMaterialBrandSelect.getProjectId(),projectMaterialRetest.getUserId())){
            return projectMaterialRetestBusinessService.getViewBypProjectMaterialRetestUserId(projectMaterialRetest.getUserId());
        }
        else {return null;
        }
