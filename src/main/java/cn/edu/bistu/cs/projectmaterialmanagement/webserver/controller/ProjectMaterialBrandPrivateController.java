...
public class ProjectMaterialBrandPrivateController {
    ...
    @GetMapping(value = "get-view-by-project-material-id")
    public List<ProjectMaterialBrandPrivateView> getViewByProjectMaterialId(@RequestParam(value = "projectMaterialId") String projectMaterialId) {
        return projectMaterialBrandPrivateService.getViewByProjectMaterialId(projectMaterialId);
    }

    @GetMapping(value = "get-view-by-project-id-and-material-id")
    public List<ProjectMaterialBrandPrivateView> getViewByProjectIdAndMaterialId(@RequestParam(value = "projectId") String projectId,
                                                                            @RequestParam(value = "materialId") String materialId) {
        return projectMaterialBrandPrivateService.getViewByProjectIdAndMaterialId(projectId,materialId);
    }
