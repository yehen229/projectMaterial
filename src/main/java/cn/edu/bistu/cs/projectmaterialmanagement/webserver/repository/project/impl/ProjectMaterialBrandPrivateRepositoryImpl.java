...
public class ProjectMaterialBrandPrivateRepositoryImpl implements IProjectMaterialBrandPrivateRepository {
    ...
    @Override
    public List<ProjectMaterialBrandPrivate> getByProjectIdAndMaterialId(String projectId,
                                                                         String materialId) {
        Integer i = jdbcTemplate.queryForObject("""
                                                        SELECT count(*) 
                                                        FROM t_project_material_brand_private                                                        
                                                        LEFT JOIN t_project_material ON t_project_material.id=t_project_material_brand_private.t_project_material_id
                                                        WHERE t_project_id=?  AND t_material_id=? 
        ...
        return jdbcTemplate.query("""
                                          ...
                                          AND t_project_material_brand_private.deleted_at IS NULL 
                                          """,
                                  new ProjectMaterialBrandPrivateMapper(), projectId,materialId);
    }
