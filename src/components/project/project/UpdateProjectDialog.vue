...
const onOpenDialog = async () => {
  ...
  projectForm.name = props.projectView.project.name;
  projectForm.location = JSON.parse(props.projectView.project.location);
  projectForm.totalInvestmentWithTax =
    props.projectView.project.totalTaxIncluded;
  projectForm.totalInvestmentWithoutTax =
    props.projectView.project.totalTaxNotIncluded;
  projectForm.buildingAreaAboveGround =
    props.projectView.project.buildingAreaAboveGround;
  projectForm.buildingAreaUnderGround =
    props.projectView.project.buildingAreaUnderGround;
  projectForm.companyConstructionId =
    props.projectView.project.companyConstructionId;
  projectForm.companyDesignId = props.projectView.project.companyDesignId;
  projectForm.approvalDate = props.projectView.project.createDatetime;
};
    ...
    if (valid) {
      try {
        ...
        const project: IServerProject = {
          id: props.projectView.project.id,
          userId: userId,
          ...
          note: projectForm.note, // 根据需要填充
          createDatetime: props.projectView.project.createDatetime,
