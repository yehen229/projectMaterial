...
interface Props {
  ...
  updateProjectBrandView: IServerProjectBrandView;
}
...
const onOpenDialog = async () => {
  ...
  form.id = props.updateProjectBrandView.projectBrand.brandId;
  form.materialClassifySectionId =
    props.updateProjectBrandView.brandView.brand.materialClassifySectionId;
  form.name = props.updateProjectBrandView.brandView.brand.name;
  form.position = props.updateProjectBrandView.brandView.brand.position;
};
