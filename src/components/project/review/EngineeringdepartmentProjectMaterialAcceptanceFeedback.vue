...
const projectReviewUserViewData = ref<IServerProjectMaterialAcceptanceReviewUserView>();
...
const getProjectReviewUserViewPageFromServer = async () => {
  ...
  if (
    ...
    const ret =
      await serverGetFeedbackOfProjectMaterialAcceptanceReviewedOfEngineeringDepartmentByProjectIdAndTaskId(
        projectUserTask.projectView.project.id,
        projectUserTask.taskId
      );
    console.log(ret);
...
<template>
  <div
    ...
    v-if="
      projectReviewUserViewData &&
      projectReviewUserViewData.projectMaterialAcceptanceReview
    "
  >
    ...
    <div class="project-container" v-show="!collapsed">
      ...
      <div style="display: flex; margin: 10px; align-items: baseline">
        ...
        <div>
          {{
            projectReviewUserViewData?.projectMaterialAcceptanceReviewUser.reviewContent
          }}
        </div>
      </div>
      ...
      <div style="display: flex; margin: 10px; align-items: baseline">
        ...
        <div>
          {{
            formatDate(
              projectReviewUserViewData?.projectMaterialAcceptanceReviewUser
                .reviewDatetime
            )
          }}
        </div>
      ...
      <div style="display: flex; margin: 10px; align-items: baseline">
        ...
        <div>
          <div
            v-for="(
              item, index
            ) in projectReviewUserViewData?.projectMaterialAcceptanceReviewUserFileList"
            :key="index"
