...
interface Props {
  ...
  companyUserView: IServerCompanyUserView;
}
...
const form = reactive<IServerCompanyUserForm>({
  companyUserId: "",
  companyId: "", //company_id,单位id
  userRealName: "", //user_id,用户id
  tel: "",
  email: "",
});
...
const onOpenDialog = async () => {
  form.companyUserId = props.companyUserView.companyUser.id;
  form.companyId = props.companyUserView.company.id;
  form.userRealName = props.companyUserView.user.realName;
  form.tel = props.companyUserView.user.tel;
  form.email = props.companyUserView.user.email;
