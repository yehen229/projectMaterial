...
const form = reactive<IServerCompany>({
  id: props.company.id, //id,主键
  name: props.company.name, //单位名称单位名称
  companyType: props.company.companyType, //company_type,单位类型：设计单位、设计部、工程部、监理单位、总包单位等单位类型：设计单位、设计部、工程部、监理单位、总包单位等
  note: props.company.note, //note,备注备注
  deletedAt: new Date(),
});
...
const onOpenDialog = async () => {
  form.id = props.company.id; //id,主键
  form.name = props.company.name; //name,单位名称单位名称
  form.companyType = props.company.companyType; //company_type,单位类型：设计单位、设计部、工程部、监理单位、总包单位等单位类型：设计单位、设计部、工程部、监理单位、总包单位等
  form.note = props.company.note; //note,备注备注
};
