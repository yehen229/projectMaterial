...
import {
  ...
  serverSubmitAffectAppearanceReviewOfDesignDepartmentEmployee,
...
const submitToServerReviewOfEmployee = async (userId: string) => {
  ...
  // 调用API
  const response =
    await serverSubmitAffectAppearanceReviewOfDesignDepartmentEmployee(
...
<template>
  ...
  <div class="tab-container">
    ...
    <div v-if="projectUserTask">
      <el-alert title="项目员工填写意见，然后项目经理进行汇总" type="info" />
