...
const submitToServerManagerDirect = async (userId: string) => {
  ...
  //直接审核
  const appearanceReviewForm: IServerProjectAppearanceReviewEmployeeForm = {
  ...
  console.log(appearanceReviewForm);

  // 调用API
  const response = await serverSubmitSupervisionCompanyReviewSelectBrand(
