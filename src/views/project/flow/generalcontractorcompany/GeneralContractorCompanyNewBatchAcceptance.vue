...
import {
  ...
  serversubmitGeneralContractorNewTaskOfProjectMaterialAcceptance,
...
const submitProcess = async () => {
  ...
  // 调用API
  const response =
    await serversubmitGeneralContractorNewTaskOfProjectMaterialAcceptance(
      batchForm
    );
...
<template>
  ...
  <div class="tab-container">
    <div class="project-container container">
      <div style="font: 1.2em sans-serif; margin: 10px">物料验收</div>
