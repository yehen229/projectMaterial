...
import {
  ...
  serverSubmitAffectAppearanceRemainReviewOfEngineeringDepartmentOfManager,
...
const submitToServerManagerDirect = async (userId: string) => {
  ...
  // 调用API
  const response =
    await serverSubmitAffectAppearanceRemainReviewOfEngineeringDepartmentOfManager(
