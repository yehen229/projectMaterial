...
import {
  ...
  serverSubmitNotAffectAppearanceReviewOfEngineeringDepartmentManagerDirect,
  serverSubmitNotAffectAppearanceReviewOfEngineeringDepartmentManagerDispatchToEmployee,
...
onBeforeRouteUpdate(async (to) => {
  ...
  if (
    ...
    "Activity_Not_Affect_Appearance_Engineering_Department_Distribution_Review"
  )
...
const submitToServerManagerDistributeToEmployees = async (userId: string) => {
  ...
  // 调用API
  const response =
    await serverSubmitNotAffectAppearanceReviewOfEngineeringDepartmentManagerDispatchToEmployee(
...
const submitToServerManagerDirect = async (userId: string) => {
  ...
  // 调用API
  const response =
    await serverSubmitNotAffectAppearanceReviewOfEngineeringDepartmentManagerDirect(
...
const selectReverse = () => {
  ...
  checkList.value = [];
  employeeList.value.forEach((item: IServerUser) => {
