...
import {
  ...
  serverSubmitProjectMaterialAcceptanceRemainReviewOfEngineeringDepartmentOfManager,
...
const submitToServerManagerDirect = async (userId: string) => {
  const projectAppearanceReviewEmployeeForm: IServerProjectMaterialAcceptanceReviewEmployeeForm =
    {
  ...
  // 调用API
  const response =
    await serverSubmitProjectMaterialAcceptanceRemainReviewOfEngineeringDepartmentOfManager(
...
<template>
  ...
  <div class="tab-container">
    ...
    <div v-if="projectUserTask">
      <el-alert title="项目经理填写意见" type="info" />
