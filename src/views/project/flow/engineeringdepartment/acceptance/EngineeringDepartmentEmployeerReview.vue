...
const submitToServerReviewOfEmployee = async (userId: string) => {
  const projectMatrialAcceptanceReviewEmployeeForm: IServerProjectMaterialAcceptanceReviewEmployeeForm =
    {
  ...
  console.log(projectMatrialAcceptanceReviewEmployeeForm);

  // 调用API
  const response =
    await serverSubmitProjectMaterialAcceptanceReviewOfEngineeringDepartmentEmployee(
