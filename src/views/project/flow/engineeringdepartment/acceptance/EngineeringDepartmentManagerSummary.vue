...
import {
  ...
  serverSubmitProjectMaterialAcceptanceReviewOfEngineeringDepartmentManagerSummary,
...
import {
  ...
  serverGetStatisticsOfProjectReviewUserViewByProjectReviewId,
  serverGetStatisticsOfProjectAppearanceReviewUserViewByTaskId, 
    serverGetStatisticsOfEngineeringDepartmentMaterialAcceptanceReviewUserViewByTaskId,
...
const projectReviewUserViewList = ref<IServerProjectMaterialAcceptanceReviewUserView[]>(
  []
);
const projectReviewStatistics = ref<IServerProjectReviewStatistics>();
const employeeProjectReviewUserViewList = ref<
  IServerProjectMaterialAcceptanceReviewUserView[]
>([]);
...
const getStatisticsOfProjectReviewUserFromServer = async () => {
  if (projectUserTask.value && projectUserTask.value.taskId) {
    const ret =
      await serverGetStatisticsOfEngineeringDepartmentMaterialAcceptanceReviewUserViewByTaskId(
...
const submitToServerManagerDirect = async (userId: string) => {
  ...
  //直接审核
  const projectAppearanceReviewManagerSummaryForm: IServerProjectMaterialAcceptanceReviewManagerSummaryForm =
    {
  ...
  console.log(projectAppearanceReviewManagerSummaryForm);

  // 调用API
  const response =
    await serverSubmitProjectMaterialAcceptanceReviewOfEngineeringDepartmentManagerSummary(
...
const onSetAllEmployeeFilesAsManagerFiles = (
  _projectReviewUserViewList: IServerProjectMaterialAcceptanceReviewUserView[]
) => {
...
<template>
  ...
  <div class="tab-container">
    ...
    <div v-if="projectUserTask">
      ...
      <div class="review-container container">
        <div>项目员工审核情况</div>
        <ProjectMaterialAcceptanceReviewList
          :projectUserTask="projectUserTask"
